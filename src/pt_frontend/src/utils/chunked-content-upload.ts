...
export const CHUNK_SIZE = 1048576; // 1MB chunks
export const MAX_DIRECT_UPLOAD_SIZE = 512 * 1024; // 512KB - send smaller content directly
...
/**
 * Generic chunked upload function that can work with different upload endpoints
 */
export async function uploadContentInChunks<T>({
  contents,
