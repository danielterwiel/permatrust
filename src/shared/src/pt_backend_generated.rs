...
impl Service {
    ...
    pub async fn create_workflow(&self, arg0: String, arg1: String) -> Result<(WorkflowIdResult,)> {
        ic_cdk::call(self.0, "create_workflow", (arg0, arg1)).await
    }
