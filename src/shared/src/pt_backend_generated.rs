...
#[derive(CandidType, Deserialize)]
pub struct DocPaginationInput {
    pub filters: Option<Vec<FilterCriteria>>,
...
impl Service {
    ...
    pub async fn list_documents(
        &self,
        arg0: DocPaginationInput,
    ) -> Result<(PaginatedDocumentsResult,)> {
        ic_cdk::call(self.0, "list_documents", (arg0,)).await
    }
    pub async fn list_documents_by_project_id(
        &self,
        arg0: ProjectId,
        arg1: DocPaginationInput,
    ) -> Result<(PaginatedDocumentsResult,)> {
        ic_cdk::call(self.0, "list_documents_by_project_id", (arg0, arg1)).await
    }
    pub async fn list_organisations(
        &self,
        arg0: PaginationInput,
    ) -> Result<(PaginatedOrganisationsResult,)> {
    ...
    pub async fn list_projects_by_organisation_id(
        &self,
        arg0: OrganisationId,
        arg1: PaginationInput,
    ...
    pub async fn list_revisions(
        &self,
        arg0: PaginationInput,
    ) -> Result<(PaginatedRevisionsResult,)> {
        ic_cdk::call(self.0, "list_revisions", (arg0,)).await
    }
    pub async fn list_revisions_by_document_id(
        &self,
        arg0: DocumentId,
        arg1: PaginationInput,
    ) -> Result<(PaginatedRevisionsResult,)> {
    ...
    pub async fn list_workflows(
        &self,
        arg0: PaginationInput,
    ) -> Result<(PaginatedWorkflowsResult,)> {
