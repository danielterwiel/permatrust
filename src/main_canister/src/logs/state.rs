...
use shared::consts::memory_ids::main_canister::LOGS_STORAGE_MEMORY_ID;
...
pub struct MainLogStorage;

impl LogStorage for MainLogStorage {
...
pub fn init_log_storage() -> MainLogStorage {
    MainLogStorage
}
